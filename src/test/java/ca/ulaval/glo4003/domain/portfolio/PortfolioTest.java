...
public class PortfolioTest {
  ...
  private final StockValue SOME_STOCK_VALUE = StockValue.create(SOME_VALUE);
  ...
  private void setupStockWithHighestVariation(LocalDate from) {
    ...
    StockValue someOtherStockValue = StockValue.create(someOtherValue, someOtherValue, someOtherValue);
